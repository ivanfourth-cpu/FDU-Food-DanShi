...
const stallsData = {
  ...
  '北食': ['一楼-自选', '一楼-早餐', '一楼-汉堡', '一楼-鱼粉', '一楼-烤鸭', '一楼-日式/铁板', '一楼-西餐厅', '一楼-早餐面条(最左侧)', '一楼-中式点心(左二)', '一楼-铁板饭(左)', '一楼-滑蛋饭', '一楼-煎饼/烤冷面', '一楼-麻辣香锅/烫', '一楼-小炒盖饭', '一楼-渝舍小面', '一楼-浏阳蒸菜', '一楼-港式烧腊', '一楼-广式蒸点', '一楼-陕西面', '一楼-铁板烧(右侧)', '一楼-粤式饭(颐满记)', '二楼-饮料吧', '二楼-烧烤', '二楼-蒸菜', '二楼-红烧牛肉面', '二楼-千里香小馄饨', '二楼-早餐', '二楼-米线', '二楼-小炒', '二楼-茄汁面', '二楼-白切鸡', '二楼-自选', '二楼-民族餐厅'],
...
function updateReview(id, updates) {
  ...
  if (updates.canteen !== undefined) { fields.push('canteen = ?'); values.push(updates.canteen); }
  if (updates.stall !== undefined) { fields.push('stall = ?'); values.push(updates.stall); }
  if (updates.dish !== undefined) { fields.push('dish = ?'); values.push(updates.dish); }
